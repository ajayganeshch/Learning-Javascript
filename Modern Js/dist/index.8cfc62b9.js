...
// console.log(stClone);
let stCloneDeep = (0, _cloneDeepJsDefault.default)(state);
state.user.logged = false;
...
let cart = [];
let addToCart = function(product, quantilty) {
    cart.push({
        product,
        quantilty
    });
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gAoaA","6rimH"], "6rimH", "parcelRequire1c51")
