...
let disableFun = function (toDisable) {
  toDisable.setAttribute("disabled", "disabled");
};
...
let checkForWinner = function () {
  ...
  if ([...checkWin_arr_1] === [...checkWin_arr_2]) {
    document.querySelector(".t-p-u").classList.remove("hidden");
    disableFun("clearInput");
    disableFun("btnPlay");
  } else {
